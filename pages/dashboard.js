    ...
    return (
         <div >
           ...
           <div className = "flex justify-center">
               ...
               <HeadAlert >{{account:account,createdNumber:`You have created ${creathedItems.length} NFT Items`,title:"Number of Created Items"}}</HeadAlert>

              {
                  !creathedItems.length ? 
                   <h1 className=" py-20 text-4xl tracking-tight font-extrabold text-yellow-500 sm:text-5xl md:text-6xl">
                  <span className="block lg:py-3 xl:inline">No NFTs </span>
                  </h1> :<>
      ...
      <div className="w-80 mt-24 m-auto lg:mt-16 max-w-sm">
        ...
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
            ...
            <div className="col-span-2 pt-1 ">
              <p className="text-gray-800 font-bold lg:text-sm">Royalty</p>
              <p className="text-gray-500 text-sm font-bold">{item.royalty} ETH</p>
            </div>
          ...
          <div className="text-center m-auto mt-6 w-full h-1">
           ...
           <div className = "flex justify-center">
               <div className="px-4 " style={{maxWidth:"1600px"}}>
                <HeadAlert >{{createdNumber:`NFTs Sold: ${soldItems.length} `,title:"NFTs Sold"}}</HeadAlert>
